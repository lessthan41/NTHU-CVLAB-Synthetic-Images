...
## Why use DSAII?
DSAII dataset contains normal images with _large intra-class variation_, while defective images are generated by diffusion model. This setting aims to evaluate the model’s _generalizability_ and _few-shot capabilities_. The model needs to learn the abstract pattern of the object/texture and the its normal appearance to achieve better performance.
